package com.space_exploration_article_service.config;
...
/**
 * The user service remains responsible for issuing tokens. This service only
 * validates them and uses the JWT subject as the external user ID.
 */
@Configuration
@EnableWebSecurity
